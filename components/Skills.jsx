...
const Skills = () => {
    return (
      <div className="pt-20 w-full">
        ...
        <div className="flex flex-wrap items-center justify-center p-4 gap-2 lg:ml-[70px] lg:mr-[74px]">
          {iconLists.map((item) => (
            <div 
          ...
          {/* {skills.map((item) => (
            <div 
              style={{paddingTop: '2px', paddingBottom: '9px'}}
              className="px-5 lg:min-h-[10rem] h-[7.5rem] flex items-center justify-center backdrop-filter backdrop-blur-lg saturate-180 bg-opacity-75 bg-black-100 rounded-lg border border-black-300"
              key={item.id}>
                <div className="flex items-center justify-center mt-2">
